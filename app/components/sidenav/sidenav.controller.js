(function() {
  ...
  function SidenavCtrl(
    ...
    var sideNavTitlePadding = angular.element(
      $element[0].querySelector("#sidenav-title")
    );
    ...
    $scope.toggleExpand = function() {
      ...
      if ($scope.navExpanded) $log.debug("expanded.");
    };
  ...
  angular.module("enviroCar").controller("SidenavCtrl", SidenavCtrl);
})();
